  ...
  <div class="container-fluid">
    <div class="row min-vh-100 align-items-stretch">
      ...
      <main class="col-12 col-md-10 p-4 bg-light">
        <button class="btn btn-outline-dark d-md-none mb-4" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileSidebar" aria-controls="mobileSidebar" aria-label="Open menu">
